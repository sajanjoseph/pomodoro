...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PomEntry.difficulty'
        db.add_column('pomlogger_pomentry', 'difficulty',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PomEntry.difficulty'
        db.delete_column('pomlogger_pomentry', 'difficulty')
