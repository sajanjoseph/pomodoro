...
DATABASE_NAME = 'newpomdb'             # Or path to database file if using sqlite3.
DATABASE_USER = 'sajan'             # Not used with sqlite3.
DATABASE_PASSWORD = 'sajan'         # Not used with sqlite3.
...
TEMPLATE_DIRS = (
    ...
    '/home/sajan/dev/python/django/pomodoro/pomlogger/pomlogtemplates',
)
