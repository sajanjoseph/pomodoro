...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PomCategory', fields ['name']
        db.delete_unique('pomlogger_pomcategory', ['name'])

        # Adding unique constraint on 'PomCategory', fields ['name', 'creator']
        db.create_unique('pomlogger_pomcategory', ['name', 'creator_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PomCategory', fields ['name', 'creator']
        db.delete_unique('pomlogger_pomcategory', ['name', 'creator_id'])

        # Adding unique constraint on 'PomCategory', fields ['name']
        db.create_unique('pomlogger_pomcategory', ['name'])
    ...
    models = {
        ...
        'pomlogger.pomcategory': {
            'Meta': {'unique_together': "(('name', 'creator'),)", 'object_name': 'PomCategory'},
